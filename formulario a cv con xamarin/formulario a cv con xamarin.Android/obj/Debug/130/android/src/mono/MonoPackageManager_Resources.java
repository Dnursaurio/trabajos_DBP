...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "formulario a cv con xamarin.Android.dll" comes first in this list. */
		"formulario a cv con xamarin.Android.dll",
		"FormsViewGroup.dll",
		"formulario a cv con xamarin.dll",
